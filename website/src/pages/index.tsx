...
export default function Home(): JSX.Element {
  useEffect(() => {
    sdk.embedProjectId("demo", "stripe-event-types", {
    ...
    <Layout>
      <header className="hero hero--primary">
        <div className="container">
          <h1 className="hero__title">
            TypeScript Typings for Stripe Webhooks
          </h1>
          ...
          <iframe
            src="https://ghbtns.com/github-btn.html?user=kgajera&repo=stripe-event-types&type=star&count=true&size=large"
            width="170"
            height="30"
            title="GitHub"
          />
      ...
      <main>
        <div className="container margin-top--xl text-center">
          <code className="padding--sm install-command">
        ...
        <div className="container margin-top--lg margin-bottom--xl">
          ...
          >
            ...
            <div style={{ fontSize: 19, fontWeight: 500, marginTop: -10 }}>
              Try it out!
            </div>
          </div>
          <div id="demo" />
